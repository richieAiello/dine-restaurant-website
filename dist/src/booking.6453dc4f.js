...
**********************************************/ monthInput.addEventListener('change', (e)=>{
    if (months30days.includes(monthInput.value)) dayInput.setAttribute('max', '30');
    else if (monthInput.value === "2") dayInput.setAttribute('max', '28');
    else dayInput.setAttribute('max', '31');
});
